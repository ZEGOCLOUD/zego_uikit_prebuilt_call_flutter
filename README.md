...
| Caller | Callee |
| --- | --- |
|![inviter_video_calling](docs/images/caller.gif)|![inviter_video_calling](docs/images/callee.gif)|
...
![compileSdkVersion.png](docs/images/compileSdkVersion.png)
...
2. Need to add app permissions, Open the file `your_project/app/src/main/AndroidManifest.xml`, add the following code:
   ...
   ```
![/Pics/ZegoUIKit/Flutter/permission_android.png](docs/images/permission_android.png)
...
```
![/Pics/ZegoUIKit/Flutter/permission_ios.png](docs/images/permission_ios.png)

### 2. Run & Debug

Now you can simply click the **Run** or **Debug** button to build and run your App on your device.
![/Pics/ZegoUIKit/Flutter/run_flutter_project.jpg](docs/images/run_flutter_project.jpeg)
